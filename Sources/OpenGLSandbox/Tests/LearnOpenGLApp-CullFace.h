...
namespace Eugenix
{
    class LearnOpenGLCullFaceApp final : public LearnOpenGLAppBase
    {
    protected:
        ...
        void onMouseHandle(double xPos, double yPos) override
        {
            ...
            GLfloat yoffset = _lastY - yPos; // ќбратный пор€док вычитани€ потому что оконные Y-координаты возрастают с верху вниз 
