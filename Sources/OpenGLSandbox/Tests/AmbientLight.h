...
namespace Eugenix
{
	class AbmientLightApp final : public SandboxApp
	{
	protected:
	...
	private:
		...
		void CreatePipelines()
		{
			...
			uniformAmbientColor = glGetUniformLocation(_pipeline.NativeHandle(), "directionalLight.color");
			uniformAmbientIntensity = glGetUniformLocation(_pipeline.NativeHandle(), "directionalLight.ambientIntensity");
		}
