...
namespace Eugenix
{
    class LearnOpenGLStencilApp final : public LearnOpenGLAppBase
    {
    protected:
        ...
        void onRender() override
        {
            ...
            Render::OpenGL::Commands::Clear(Render::ClearFlags::Color | Render::ClearFlags::Depth | Render::ClearFlags::Stencil);
